...
// Print the solution
    ...
    //iterate over recipes with for loop and check which products i have/have not and create
    //binary string like (110110) where 1-I have this product, 0-I don't and then sort it in hashmap
    // where Integer would be id of recipe and String would be binary string
    // and display
